    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/logg.png" width="200" height="40" alt="image"/></a> </div>
        </div>
...
?>
 ...
 <a href="admin/index.php"><strong><i class="fa fa-user"></i><strong>Admin Login</strong></strong></a>
<?php }
else{
